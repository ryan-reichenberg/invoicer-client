        ...
        <div className="lg:hidden relative">
            ...
            <div className="fixed left-0 top-0 z-20 w-42 md:w-56 h-full bg-white overflow-hidden shadow-md">
                ...
                <nav className='nav-container ml-6'>
                    <svg className="w-6 h-6 font-bold absolute top-0 left-0 m-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" onClick={() => setIsNavOpen(false)}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"></path></svg>
